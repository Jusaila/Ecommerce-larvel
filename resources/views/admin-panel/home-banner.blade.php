        ...
        @endif
         <div class="col-md-12">
           <div class="card">
             ...
             <div class="card-header ">
                <a href="{{ route('banner.create') }}"><button class="bg-success">Add New</button></a>
              </div>
             <!-- /.card-header -->
             <div class="card-body">
               <table class="table table-bordered">
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td><img style="width: 50px;height:50px;" src="{{ $banner->image }}"></td>
                        ...
                        <td>
                            ...
                            <a href="{{ url('banner/edit/'.$banner->id) }}"><button class="btn btn-primary">Edit</button></a>
                        </td>
                      </tr>
                    @endforeach
