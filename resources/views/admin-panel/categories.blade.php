        ...
        @endif
         <div class="col-md-12">
           <div class="card">
             ...
             <div class="card-header ">
                <a href="{{ route('add-categories') }}"><button class="bg-success">Add New</button></a>
              </div>
             <!-- /.card-header -->
             <div class="card-body">
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{ route("category.delete") }}"  onsubmit="return confirm('Do you want delete?')" style="display:inline;">
                                @csrf
                                <input type="hidden" name="id" value="{{ $category->id }}">
                                <button class="btn btn-danger" type="submit">Delete</button>
                            </form>
                            <a href="{{ url('edit-categories/'.$category->id) }}"><button class="btn btn-primary">Edit</button></a>
                        </td>
                      </tr>
                    @endforeach
